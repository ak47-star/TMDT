...
<?php
$query="select * from dienthoai where MaDt={$_GET['id']}";
 ...
 <div class="container-fluid">
 	<div class="row">
 		<div style="padding-left: 100px;padding-top: 50px;padding-bottom: 80px;" class="col-lg-6">
 			<img class="img" style="width:300px;height: 300px;" class="image" src="img/<?php echo $imge;?>">
 		</div>
 		...
 		<div  style="width: 600px;" class="col-lg-6">
 			<div>
 				<form action="" method="POST">
 					<p style="color: red; font-size: 20px;"><?php echo number_format($price,0,',','.');  ?><small> đ</small> <button type="button" style="padding-left: 10px;margin-left: 20px;" class="btn btn-primary">Mua ngay</button> <a href="car.php" target="_bank"><button id="btn" type="button" onclick="add_cart()" style="padding-left: 10px;margin-left: 20px;" class="btn btn-primary">Thêm vào giỏ hàng</button></a></p><hr>
 			...
 			<p>
 			Đặc điểm nổi bật của <?php echo $name_phone; ?>
 ...
 <div class="container-fluid">
 	<div class="row">
 		<div class="col-lg-6" style="padding-left: 70px;" >
 			<h2 style="margin:0;">Đặc điểm nổi bật của <?php echo $name_phone; ?></h2>
            <hr>
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
        ...
        <ol class="carousel-indicators">
 			...
 			<div>
 				<h3>Sau nhiều thông tin rò rỉ thì <a href=""><?php echo $name_phone; ?></a> đã chính thức được ra mắt với nhiều trang bị cao cấp với màn hình tràn viền, camera kép xóa phông cùng một hiệu năng ổn định.</h3>
 				<hr>
 				...
 				<div style="text-align: center;" class="image">
 					...
 					<div >
 						...
 						<p style="padding-top: 10px;margin: 0">Để đánh dấu sự vượt trội về khả năng chụp ảnh của mình thì hệ thống camera kép với độ phân giải 16 MP và 5 MP cũng đã có mặt trên <?php echo $name_phone; ?> hỗ trợ khả năng xóa phông ảo diệu.
 						</p>
 					   ...
 					   <div>
 					   	Hình ảnh xoá phông chụp từ <?php echo $name_phone; ?>
 					   </div>
    ...
    <div class="row">
		...
		<div style="text-align: center;" class="col-lg-3">
			<ul>
				...
				<li><a href="#"><img src="">Intagram</a></li>
			</ul>
		</div>
	</div>
  </div>
