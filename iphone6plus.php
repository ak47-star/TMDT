 ...
 <div class="container-fluid">
 	<div class="row">
 		<div style="padding-left: 100px;padding-top: 50px;padding-bottom: 80px;" class="col-lg-6">
 			<img class="img"  style="width:300px;height: 300px; border: none;" class="image" src="http://localhost:8888/TMDT/img/ip7.jpg">
 		</div>
...
<script type="text/javascript">
 function add_cart_ip6() {
  localStorage.setItem("name_ip6","block");
 }
</script>